...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 empresa padding-zero bg-bege" id="waypointMenu">
    ...
    <div class="container conteudo">
        ...
        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12 descritivo">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 lista-itens">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero itens">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
                    ...
                    <a href="#" class="link-default item-link">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero itens">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
                    ...
                    <a href="#" class="link-default item-link">
                        <h5 class="text-center MarginT10 Bold">FAMÍLIAS&nbsp;&nbsp;<span><i class="fa fa-chevron-right" aria-hidden="true"></i></span></h5>
                    </a>
                </div>
            </div>
