<style type="text/css">
    .parallax-servicos { background-image: url("<?= RAIZSITE ?>/imagens/ban2.jpg"); background-position: center center; background-attachment: fixed; background-repeat: no-repeat; background-size: cover;}
</style>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero" id="azul" style="margin-bottom: -10px">
    <div class="item vh30">
        <div class="vh30 parallax-servicos" style="min-height: 481px;">
            <div class="container">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="margin: 180px 0px">
                    <h4 class="Uppercase size35 dourado-fonte Light">ÁREAS DE ATUAÇÃO</h4>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 MarginB1">
                    <h6 class="branco-fonte">VOCÊ ESTÁ EM HOME / <span class="dourado-fonte">ÁREAS DE ATUAÇÃO</span></h6>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero bg-branco PaddingT15p Relative">
    ...
    <div class="container">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero PaddingT2p PaddingB8p">
            <div class="col-lg-4 col-md-4 col-sm-4 hidden-xs">
                <ul class="list-unstyled">
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">ADMINISTRATIVO</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">AMBIENTAL</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">BANCÁRIO</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">CÍVEL</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">COMERCIAL</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">COMSUMIDOR</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">CONTRATOS</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">FAMÍLIA</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">GESTÃO LEGAL DE PATRIMÔNIO</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">INTERNET E E-COMMERCE</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">PROPRIEDADE INTELECTUAL</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">SOCIETÁRIO</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">SUCESSÕES</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">TRABALHISTA</a></li>
                    <li class="lista-servicos"><a href="#" class="link-default dourado-fonte lista-servicos-item">TRIBUTÁRIO</a></li>
                </ul>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero MarginB10p">
                    ...
                    <h3 class="margin-zero titulo-servicos dourado-fonte Uppercase">&nbsp;&nbsp;&nbsp;ADMINISTRATIVO</h3><br>
