...
<div class="container">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero bg-branco MarginT10p">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-8 padding-zero">
        ...
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4 padding-zero">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero" id="azul">
...
<div class="container MarginT5 MarginB8">
    ...
    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 col-sm-offset-3 padding-zero MarginT2">
        <h6 style="letter-spacing: 3px;"><a href="#" class="link-default dourado-fonte" role="button">CONHEÇA NOSSOS SERVIÇOS &nbsp; <i class="fa fa-angle-right" aria-hidden="true"></i></a></h6>
    </div>
</div>
