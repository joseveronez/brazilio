...
?>
<style type="text/css">
    .parallax-banner { background-image: url("<?= RAIZSITE ?>/cms/uploads/<?= $consulta_processual_conteudo->banner ?>"); background-position: top center; background-attachment: fixed; background-repeat: no-repeat; }
</style>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-zero bg-dourado Relative contato">
    ...
    <div class="container conteudo" style="padding-top: 80px; padding-bottom: 80px">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <form action="<?= RAIZSITE ?>/formulario/?contato" class="form-horizontal Roboto Regular formulario-trabalhe-conosco" method="post" enctype="multipart/form-data" id="formulario">
                <input type="hidden" name="email_disparo" value="<?= $config->email_consulta_processual ?>">
