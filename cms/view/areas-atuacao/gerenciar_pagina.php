...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-handshake-o" aria-hidden="true"></i>&nbsp;Áreas de Atuação - Gerenciar página</h1>
            <h4 class="sub-title">Gerenciar conteúdo da página</h4>

            <form action="<?= caminhoSite ?>/areas-atuacao/atualizar-pagina" method="post" enctype="multipart/form-data">
            	<div class="box">
                    <div class="box-title">
