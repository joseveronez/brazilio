<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;Equipe - Novo</h1>
            <h4 class="sub-title">Adicionar novo membro da equipe</h4>

            <form action="<?= caminhoSite ?>/equipe/salvar-dados" method="post" enctype="multipart/form-data" id="formInserirDados">
            	<div class="box">
                    <div class="box-title">
                    ...
                    <div class="box-content">
            			...
            			<div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="oab" maxlength="255" required />
                            </div>
                        </div><br>
            			<div class="control-group row">
                        ...
                        <div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="formacao" type="text" class="form-control tinyMCE" cols="10" rows="10" required></textarea>
                            </div>
                        </div><br>
            			<div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="foto" id="foto" class="inputfile inputfile-1" required />
