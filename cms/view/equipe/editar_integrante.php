...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-users" aria-hidden="true"></i>&nbsp;Equipe - Editar integrante</h1>
            <h4 class="sub-title">Editar dados do integrante</h4>

            <form action="<?= caminhoSite ?>/equipe/atualizar-integrante" method="post" enctype="multipart/form-data">
                        ...
                        <div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <?php
                                    if (!empty($dados->foto)) {
                                ?>
                                    <img src="<?= caminhoSite ?>/uploads/<?= $dados->foto ?>" class="img-responsive"><br />
                                <?php
                                    }
                                ?>
