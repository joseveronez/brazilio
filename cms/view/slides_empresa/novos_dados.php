<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-university" aria-hidden="true"></i>&nbsp;Slides Empresa - Novo</h1>
            <h4 class="sub-title">Adicionar novo slide</h4>

            <form action="<?= caminhoSite ?>/slides_empresa/salvar-dados" method="post" enctype="multipart/form-data" id="formInserirDados">
            	<div class="box">
                    <div class="box-title">
                    ...
                    <div class="box-content">
                        ...
                        <div class="control-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control" name="posicao" min="1" maxlength="255" required />
                            </div>
                        </div><br>
            		</div>
                </div><br>
