...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;Configurações - Gerenciar</h1>
            ...
            <form action="<?= caminhoSite ?>/configuracoes/atualizar-pagina" method="post" enctype="multipart/form-data">
            	...
            	<div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;&nbsp;Configuracoes</h3>
                    </div>
                    <div class="box-content">
            			...
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">banner_newsletter</label>

                            <div class="col-sm-10">
                                <?php
                                    if (!empty($dados->banner_newsletter)) {
                                ?>
                                    <i class="fa fa-file-archive-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<?= $dados->banner_newsletter ?><br />
                                <?php
                                    }
                                ?>
            			...
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">titulo_newsletter</label>
                            <div class="col-sm-10">
