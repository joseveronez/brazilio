...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-folder-o" aria-hidden="true"></i>&nbsp;Recuperação Judicial - Editar Arquivo</h1>
            <h4 class="sub-title">Editar dados do arquivo</h4>

            <form action="<?= caminhoSite ?>/recuperacao-judicial/atualizar-dados" method="post" enctype="multipart/form-data">
                        ...
                        <div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="id_empresa" id="id_empresa" required>
                                    ...
                                    ?>
                                        <option value="<?= $rec->id ?>" <?php if($dados->id_empresa == $rec->id) { ?> selected <?php  } ?>><?= $rec->titulo ?></option>
                                    <?php
                                        }
                                    ?>
                                </select>
