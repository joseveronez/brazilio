<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-gavel" aria-hidden="true"></i>&nbsp;Empresa - Novo slide</h1>
            <h4 class="sub-title">Adicionar novo slide</h4>

            <form action="<?= caminhoSite ?>/empresa/salvar-slide" method="post" enctype="multipart/form-data" id="formInserirDados">
            	<div class="box">
                    <div class="box-title">
