...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-bank" aria-hidden="true"></i>&nbsp;Empresa - Gerenciar</h1>
            <h4 class="sub-title">Gerenciar Página Empresa</h4>
            ...
            <form action="<?= caminhoSite ?>/empresa/atualizar-pagina" method="post" enctype="multipart/form-data">
            	...
            	<div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-bank" aria-hidden="true"></i>&nbsp;&nbsp;Empresa</h3>
                    </div>
                    <div class="box-content">
            			...
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">carousel_1</label>

                            <div class="col-sm-10">
                                <?php
                                    if (!empty($dados->carousel_1)) {
                                ?>
                                    <i class="fa fa-file-archive-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<?= $dados->carousel_1 ?><br />
                                <?php
                                    }
                                ?>

                                <input type="file" name="carousel_1[]" id="carousel_1" class="inputfile inputfile-1"  data-multiple-caption="{count} arquivos selecionados" multiple />
                                <label for="carousel_1"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Escolha o arquivo&hellip;</span></label>
                            </div>
                        </div><br>
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">carousel_2</label>

                            <div class="col-sm-10">
                                <?php
                                    if (!empty($dados->carousel_2)) {
                                ?>
                                    <i class="fa fa-file-archive-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<?= $dados->carousel_2 ?><br />
                                <?php
                                    }
                                ?>

                                <input type="file" name="carousel_2" id="carousel_2" class="inputfile inputfile-1" />
                                <label for="carousel_2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Escolha o arquivo&hellip;</span></label>
                            </div>
                        </div><br>
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">carousel_3</label>

                            <div class="col-sm-10">
                                <?php
                                    if (!empty($dados->carousel_3)) {
                                ?>
                                    <i class="fa fa-file-archive-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<?= $dados->carousel_3 ?><br />
                                <?php
                                    }
                                ?>

                                <input type="file" name="carousel_3" id="carousel_3" class="inputfile inputfile-1" />
                                <label for="carousel_3"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Escolha o arquivo&hellip;</span></label>
                            </div>
                        </div><br>
                        <div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">texto_carousel</label>
            			...
            			<div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">titulo_diferenciais</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="titulo_diferenciais" maxlength="255" value="<?= $dados->titulo_diferenciais ?>" />
                            </div>
                        </div><br>
                        <div class="control-group row">
                            <label class="col-sm-2 control-label" align="right">texto_diferenciais</label>
