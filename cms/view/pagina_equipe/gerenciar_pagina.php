...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            ...
            <form action="<?= caminhoSite ?>/pagina_equipe/atualizar-pagina" method="post" enctype="multipart/form-data">
            	<input type="hidden" name="id" value="<?= $dados->id ?>" />

            	<div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp;Equipe</h3>
                    </div>
