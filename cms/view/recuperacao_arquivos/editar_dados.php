...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-university" aria-hidden="true"></i>&nbsp;Arquivos Recuperação Judicial - Editar</h1>
            <h4 class="sub-title">Editar Arquivos</h4>

            <form action="<?= caminhoSite ?>/recuperacao_arquivos/atualizar-dados" method="post" enctype="multipart/form-data">
            	<input type="hidden" name="id" value="<?= $dados->id ?>" />

            	<div class="box">
                    <div class="box-title">
                        <h3 class="box-title-title"><i class="fa fa-handshake-o" aria-hidden="true"></i>&nbsp;&nbsp;Arquivos</h3>
                    </div>
                    <div class="box-content">
                                ...
                                <select class="form-control" name="id_recuperacao" id="id_recuperacao" required>
                                    ...
                                    <?php 
                                        foreach ($recuperacao as $rec){
                                            ?>
                                                <option value="<?= $rec->id ?>" <?php if($dados->id_recuperacao == $rec->id) { ?> selected <?php  } ?>><?= $rec->titulo ?></option>
                                            <?php
                                        }
                                    ?>
                                </select>
                        ...
                        <div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                ?>
                                    <i class="fa fa-file-archive-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;<?= $dados->arquivo ?><br />
                                <?php
                                    }
                                ?>

                                <input type="file" name="arquivo" id="arquivo" class="inputfile inputfile-1" />
                                <label for="arquivo"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Escolha o arquivo&hellip;</span></label>
                            </div>
                        </div><br>
