...
<div class="col-md-9 pull-right conteudo">
    <div class="fluid content">
        <section>
            <h1><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;Consulta Processual - Gerenciar</h1>
            <h4 class="sub-title">Gerenciar Página</h4>

            <form action="<?= caminhoSite ?>/consulta-processual/atualizar-pagina" method="post" enctype="multipart/form-data">
            	...
            	<div class="box">
                    ...
                    <div class="box-content">
                        ...
                        <div class="control-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="conteudo" maxlength="255" value="<?= $dados->conteudo ?>" />
                            </div>
                        </div><br>
                    </div>
                </div><br>
