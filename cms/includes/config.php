<?php 
	...
	if($server == "localhost:8080") {
		...
		$caminho_raiz_principal = $_SERVER['DOCUMENT_ROOT']."/brazilio";
		...
		$caminho_raiz_principal = $_SERVER['DOCUMENT_ROOT']."/projetos/brazilio";
	...
	define('caminhoFisicoPrincipal', $caminho_raiz_principal);
